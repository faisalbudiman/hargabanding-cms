...
<form id="elementer-form" action="<?php echo base_url('product_choise/multiple'); ?>" method="POST">
	<div class="row">
		<div class="col-12 col-md-12 col-lg-12">
			<div class="card">
				<div class="card-header" style="display: block;">
					<div class="dropdown d-inline float-left">
						<a class="btn btn-primary" href='<?php echo base_url('product_choise/tambah') ?>'>
							Tambah	
						</a>
					</div>					
						...
						<table class="display responsive table" id='table' width="100%">
							<thead>
								<tr>
									...
									<th class="none"><?php echo ucfirst('store_name') ?></th>
