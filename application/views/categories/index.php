...
<form id="elementer-form" action="<?php echo base_url('categories/multiple'); ?>" method="POST">
	<div class="row">
		<div class="col-12 col-md-12 col-lg-12">
			<div class="card">
				<div class="card-header" style="display: block;">
					<div class="dropdown d-inline float-left">
						<a class="btn btn-primary" href='<?php echo base_url('categories/tambah') ?>'>
							Tambah	
						</a>
					</div>					
					...
					<table class="table table-bordered" id='table' width="100%">
						<thead>
							<tr>
								...
								<th class="all"><?php echo ucfirst('id') ?></th>
								<th class="all"><?php echo ucfirst('category_name') ?></th>
								<th class="desktop"><?php echo ucfirst('category_description') ?></th>
